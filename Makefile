...
HOMEASSISTANTDOCKERFILE=$(DOCKERBUILDDIR)/Dockerfile.home-assistant
...
build-docker:
	...
	$(DOCKERBUILD):home-assistant -f $(HOMEASSISTANTDOCKERFILE) .
...
build-docker-arm64:
	...
	$(DOCKERBUILDARM64):home-assistant -f $(HOMEASSISTANTDOCKERFILE) .
...
build-docker-armv7:
	...
	$(DOCKERBUILDARMv7):home-assistant -f $(HOMEASSISTANTDOCKERFILE) .
